...
export default function Landing() {
    return (
        <section className="flex flex-col justify-evenly px-6">
            <div className="flex flex-col">

                <span className="text-(--accent-main) py-3 text-sm">  {'>'} SOFTWARE ENGINEER</span>
                <span className="text-(--text-header) text-[4rem] font-bold hero-name">Laura Antunez<span className="cursor"></span></span>
